...
INSERT INTO movies (title, year, revenue, guidance, studio_id) VALUES 
	('Yolki', 2010, 1000000, 'PG-10', (SELECT id FROM studios ORDER BY RANDOM() LIMIT 1)),
	('Yolki 2', 2011, 2000000, 'PG-13', (SELECT id FROM studios ORDER BY RANDOM() LIMIT 1)),
	('Yolki 3', 2012, 3000000, 'PG-18', (SELECT id FROM studios ORDER BY RANDOM() LIMIT 1)),
	('Kill Bill', 2013, 4000000, 'PG-10', (SELECT id FROM studios ORDER BY RANDOM() LIMIT 1)),
	('Kill Bill 2', 2014, 5000000, 'PG-13', (SELECT id FROM studios ORDER BY RANDOM() LIMIT 1)),
	('Kill Bill 3', 2015, 6000000, 'PG-18', (SELECT id FROM studios ORDER BY RANDOM() LIMIT 1));
